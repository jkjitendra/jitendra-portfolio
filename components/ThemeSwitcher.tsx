...
export default function ThemeSwitcher() {
  ...
  return (
    <button
      ...
      className={`transition-all rounded-full p-2 border border-white/10 shadow active:scale-95`}    
      style={{
          backgroundColor: theme === "light" ? "#67b5fe" : "#686c75",
      ...
      <span className="inline-block transition-transform duration-300 ease-in-out">
        {theme === "dark" ? (
          ...
          <svg width={26} height={26} viewBox="0 0 24 24">
            {/* <circle cx="12" cy="12" r="5" fill={theme === "dark" ? "#FDE68A" : "#FBBF24"} /> */}
