...
import ClassicProjectCard from "./ClassicProjectCard";
import ClassicSolarSystem from "./ClassicSolarSystem";
import ClassicMouseGradient from "./ClassicMouseGradient";
...
export default function ClassicHomeClient() {
  ...
  return (
    <main className="classic-portfolio page-glow min-h-screen">
      {/* Mouse-following gradient background */}
      <ClassicMouseGradient />
      ...
      >
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          {projects.map((p, index) => (
            <ClassicProjectCard key={p.name} project={p} index={index} />
          ))}
        </div>
      </motion.section>
