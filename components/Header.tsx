  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[70rem] flex items-center gap-[0.5rem] py-3">
        {/* LEFT: Logo */}
        <Link href="/" aria-label="Home" className="relative z-10 shrink-0 360-380:ml-[-2rem] 360-380:mr-[-1rem] 400-420:ml-[-1.5rem] 400-420:mr-[2rem] ml-[-1rem] sm:ml-[-1.5rem] lg:ml-[-2rem]">
